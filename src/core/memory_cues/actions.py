...
LOAD_TRACK_KEY = settings.LOAD_TRACK_KEY
SWITCH_FOCUS_KEY = settings.SWITCH_FOCUS_KEY
OPEN_SEARCH_TRACK_DIALOG = settings.OPEN_SEARCH_TRACK_DIALOG
ADVANCE_ONE_MESURE = settings.ADVANCE_ONE_MESURE
SET_CUE = settings.SET_CUE
SAVE_CUE_AS_MEMORY_CUE = settings.SAVE_CUE_AS_MEMORY_CUE
ADVANCE_ONE_BEAT = settings.ADVANCE_ONE_BEAT
PLAY_PAUSE_TRACK = settings.PLAY_PAUSE_TRACK
LAYOUT_2_DECKS_HORIZONTAL = settings.LAYOUT_2_DECKS_HORIZONTAL
NEXT_TRACK_IN_COLLECTION_KEY = settings.NEXT_TRACK_IN_COLLECTION_KEY
PREVIOUS_TRACK_IN_COLLECTION_KEY = settings.PREVIOUS_TRACK_IN_COLLECTION_KEY
